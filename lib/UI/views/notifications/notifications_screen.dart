...
import 'package:kemsu_app/UI/views/notifications/bloc/notifications_bloc.dart';
        ...
        builder: (context, state) {
          switch (state.status) {
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Align(
                                                ...
                                                child:
                                                    Text("${item.notificationDateTime}", style: const TextStyle(fontSize: 12, color: Colors.white, fontWeight: FontWeight.normal))),
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: FlutterPolls(
                                                        ...
                                                        pollOptions: item.voteList
                                                                ?.map((option) =>
                                                                    PollOption(id: "${option.voteId}", title: Text(option.optionText ?? ""), votes: option.voteCnt ?? 0))
                                                                .toList() ??
                                                            []),
                                                  ),
                                                ),
            ...
            case NotificationStatus.error:
              return Center(
                child: Text('Notifications Error'),
              );
          }
        },
      ),
