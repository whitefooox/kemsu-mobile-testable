...
class Localizable {
  ...
  static String mainReset = 'Сбросить';
  static String mainExit = 'Выйти';
  static String mainSupport = 'Поддержка';
  static String mainGallery = 'Галерея';
  static String mainCamera = 'Камера';
  static String mainStudent = 'Студент';
  static String mainTeacher = 'Преподаватель';
